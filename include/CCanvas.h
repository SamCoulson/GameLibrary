...
public:
	...
	void drawText(std::string text, int pos_x, int pos_y, std::string fontName, int fontSize, Uint8 r, Uint8 g, Uint8 b);
	...
	SDL_Texture* loadImage(std::string filename, Uint8 r, Uint8 g, Uint8 b); // Really should move this to its own class but has SDL dependecies
